...
public class ProductBook {
    ...
    TradableDTO add(Tradable t) throws InvalidUserInput, DataValidationException, InvalidPriceOperation {
        ...
        try {
            ...
            PerformanceMonitor.getInstance().recordLatency(System.nanoTime() - startNanos);
        }

    }

    TradableDTO[] add(Quote qte) throws InvalidUserInput, DataValidationException, InvalidPriceOperation {
    ...
    TradableDTO cancel(BookSide side, String orderId) throws InvalidUserInput, InvalidPriceOperation {
        TradableDTO sides;
        if (side == BUY) {
    ...
    private void tryTrade() throws InvalidUserInput, DataValidationException {
    ...
    TradableDTO[] removeQuotesForUser(String userName) throws InvalidUserInput, InvalidPriceOperation {
